...
#SBATCH --output=/project/mgreenst/energy_flux/code/log/download_2020_1_50.out  # Where stdout goes
#SBATCH --error=/project/mgreenst/energy_flux/code/log/download_2020_1_50.err   # Where stderr goes
...
OUT_DIR="/project/mgreenst/energy_flux/rawdata/modis_l2"
