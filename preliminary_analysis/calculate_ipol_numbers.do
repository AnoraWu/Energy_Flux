...
use "$raw_data/skeleton_merged2024_ssf_resid.dta", clear

local varlist sw_radiance_up_resid 
...
forval i = 1/7 {
	gen net_sw_surface_flux_resid_`i' = round(l`i'.net_sw_surface_flux_resid, 20)
}
