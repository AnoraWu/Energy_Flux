...
drop if pre_mars==. & fraction==.& GPM_20_20==. & velocity==. & air_fraction_mean==. 
...
logit imply fraction_pre1 fraction_pre2 fraction_pre3 fraction_pre4 fraction_pre5 fraction_pre6 fraction_pre7 ///
...
save "$final/pscore_nothickness.dta", replace
