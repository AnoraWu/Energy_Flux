...
forval i = 1/7 {
	gen sw_toa_flux_up_`i' = round(l`i'.sw_toa_flux_up, 20)
}

forval i = 1/7 {
	gen net_sw_surface_flux_`i' = round(l`i'.net_sw_surface_flux, 30)
}

forval i = 1/7 {
	gen sw_radiance_up_`i' = round(l`i'.sw_radiance_up, 10)
}

forval i = 1/7 {
	gen lw_toa_flux_up_`i' = round(l`i'.lw_toa_flux_up, 10)
}

forval i = 1/7 {
	gen net_lw_surface_flux_`i' = round(l`i'.net_lw_surface_flux, 10)
}

save "$raw_data/skeleton_merged2024_ssf_lags.dta", replace




use "$raw_data/skeleton_merged2024_ssf_lags.dta", replace

local varlist net_sw_surface_flux sw_radiance_up lw_toa_flux_up net_lw_surface_flux sw_toa_flux_up
